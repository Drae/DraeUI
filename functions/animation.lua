...
function T:StopShake(object)
	if object.shake then
		object.shake:Finish()
	end
end

function T:ShakeHorizontal(object)
...
function T:StopShakeHorizontal(object)
...
function T:SlideIn(object, customName)
	if not customName then
		customName = 'anim'
	end
...
function T:SlideOut(object, customName)
	if not customName then
		customName = 'anim'
	end
	if not object[customName] then return end
