...
local StyleDrae_Target = function(frame, unit, isSingle)
	...
	frame.Health.value = DraeUI.CreateFontObject(frame, DraeUI.config["general"].fontsize1, DraeUI["media"].font, "LEFT", -2, 15)

	local level = DraeUI.CreateFontObject(frame.Health, DraeUI.config["general"].fontsize1, DraeUI["media"].font, "RIGHT", 2, 15)
	...
	-- Auras
	UF.AddBuffs(frame, "TOPLEFT", frame.Power, "BOTTOMLEFT", 0, -12, DraeUI.config["frames"].auras.maxTargetBuff or 8, DraeUI.config["frames"].auras.auraLrg, 8, "RIGHT", "DOWN")
	UF.AddDebuffs(frame, "TOPRIGHT", frame.Power, "BOTTOMRIGHT", 0, -12, DraeUI.config["frames"].auras.maxTargetDebuff or 6, DraeUI.config["frames"].auras.auraSml, 8, "LEFT", "DOWN")
