-- TODO to complete this module:
----> Fix Lag on Bank when Create is executed, with TONS of Buttons.
----> add a way to identify special bag slots for professions
...
function Bags:UpdateAllBags()
	...
	if (Token1:IsShown()) then
		...
		Bags.Bag:SetHeight(((ButtonSize + ButtonSpacing) * (NumRows + 1) + 54) - ButtonSpacing)
	end
end
